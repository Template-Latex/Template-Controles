...
\usepackage{floatpag}      % Maneja estilos de páginas introducidos por obj. flotantes
...
%	#3	Ancho de la línea (en pt)
%	#4	Link de la imagen
\newcommand{\addimageanumboxedlink}[4]{%
	\addimageboxedlink{#1}{#2}{#3}{#4}{}%
}
...
\newcommand{\insertimageboxed}[5][]{%
	...
	\begin{figure}[H]%
		...
		\else%
			\hspace{0cm}%
			\ifthenelse{\equal{\captionmarginimage}{0}}{}{\corevspacevarcm{\captionmarginimage}}%
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.5.7-CTR/EXM},
		Template.Version.Hash={F062198FCFE1ECD81CE66E43C0040EB3},
		Template.Version.Release={4.5.7},
	...
	pdfproducer={Template-Controles v4.5.7 | (Pablo Pizarro R.) ppizarror.com},
