...
% Versión:      5.4.3 (12/07/2026)
% Codificación: UTF-8
%
% Autor: Pablo Pizarro R.
%        pablo@ppizarror.com
%
% Manual template: [https://template-latex.github.io/controles]
...
\newcommand{\corepatchatleast}[2]{
	\ifdefined\IfFormatAtLeastTF
		\IfFormatAtLeastTF{#1}{}{#2}%
	\else
		#2
	\fi
}
% Desde LaTeX 2025-06-01 amsmath define \numberwithin como copia de \counterwithin;
% borrar \counterwithin deja \numberwithin indefinido y rompe el hook de hyperref
% ("Command \numberwithin undefined"). Se aplica el parche solo en formatos
% anteriores a 2025-06-01, donde amsmath aún define \numberwithin de forma propia.
\corepatchatleast{2025-06-01}{
...
\ifthenelse{\equal{\showlinenumbers}{true}}{% Muestra los números de línea
	\ifthenelse{\equal{\linenumberspagereset}{true}}{% Reinicia la numeración en cada página
		\usepackage[left,pagewise]{lineno}
	}{% Numeración continua (compatible con multicol)
...
\newenvironment{appendixd}{%
	...
	% bookmark valida 'numbered' como booleano literal (true/false), no una macro:
	% se expanden los valores antes de pasarlos a \bookmarksetup.
	\begingroup
	\edef\x{\endgroup
...
\newenvironment{images}[2][]{%
	...
	\begin{figure}[H] \centering%
		...
		}{\ifdefined\HCode\ifthenelse{\equal{\envimagescaptionvar}{}}{}{\refstepcounter{figure}}\fi}%
		...
		\ifthenelse{\equal{\envimagescaptionvar}{}}{%
			...
			\ifthenelse{\equal{\envimagescaptioncf}{true}}{%
				...
				\ifdefined\HCode\addtocounter{figure}{-1}\fi%
				\caption{\envimagescaptionvar\envimageslabelvar}%
			}%
		}%
	\end{figure}%
...
\ifthenelse{\isundefined{\evaluationindication}}{
...
\ifthenelse{\equal{\usepdfmetadata}{true}}{
	...
	\def\pdfmetainfosubject {\documenttitle}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={5.4.3-CTR/EXM},
		Template.Version.Hash={1E41A4FECD156850A71BB990D88A5220},
		Template.Version.Release={5.4.3},
		Template.Web.Dev={https://github.com/Template-Latex/Template-Controles},
		Template.Web.Manual={https://template-latex.github.io/controles},
	...
	pdfproducer={Template-Controles v5.4.3 | (Pablo Pizarro R.) ppizarror.com},
