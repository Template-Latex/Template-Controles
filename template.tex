...
\ifthenelse{\equal{\usepdfmetadata}{true}}{
	...
	\def\pdfmetainfotema {\titulodeldocumento}
	\def\pdfmetainfotitulo {\titulodeldocumento}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.4.2-CTR/EXM},
		Template.Version.Hash={445CD93CC62E90B799FE83FF7802D389},
		Template.Version.Release={4.4.2},
	...
	pdfproducer={Template-Controles v4.4.2 | (Pablo Pizarro R.) ppizarror.com},
...
\newcommand{\templatePagecfg}{
	...
	\newcommand{\COREstyledefinition}{
		...
		\fancyfoot[L]{\small \rm \textit{\titulodeldocumento}} % Footer izq, título
