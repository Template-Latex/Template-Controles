...
\def\GLOBALcoretikzimported {false}      % Indica que tikz se importó
...
\newcommand{\imagesnewline}{\checkonlyonenvimage\def\GLOBALenvimageadded {false}\linebreak\noindent}
...
% Insertar una imagen en un entorno multicol
% 	#1	Label (opcional)
%	#2	Dirección de la imagen
%	#3	Parámetros de la imagen
%	#4	Leyenda de la imagen (opcional)
\newcommand{\insertimagemc}[4][]{%
	\setcaptionmargincm{\captionlrmarginmc}
	\insertimageboxed[#1]{#2}{#3}{0}{#4}
	\setcaptionmargincm{\captionlrmargin}
}

% Insertar una imagen con recuadro en un entorno multicol
% 	#1	Label (opcional)
%	#2	Dirección de la imagen
%	#3	Parámetros de la imagen
%	#4	Ancho de la línea (en pt)
%	#5	Leyenda de la imagen (opcional)
\newcommand{\insertimageboxedmc}[5][]{%
	\setcaptionmargincm{\captionlrmarginmc}
	\insertimageboxed[#1]{#2}{#3}{#4}{#5}
	\setcaptionmargincm{\captionlrmargin}
}
...
%	#5	Leyenda de la imagen (opcional)
\newcommand{\insertimagemcfull}[5][]{%
	\insertimageboxedmcfull[#1]{#2}{#3}{0}{#4}{#5}
}
...
\newcommand{\insertimageboxedmcfull}[6][]{%
	\emptyvarerr{\insertimageboxedmcfull}{#2}{Direccion de la imagen no definida}
	\emptyvarerr{\insertimageboxedmcfull}{#3}{Parametros de la imagen no definidos}
	\emptyvarerr{\insertimageboxedmcfull}{#4}{Ancho de la linea no definido}
	\emptyvarerr{\insertimageboxedmcfull}{#5}{Posicion de la imagen no definida}
	\checkoutsideenvimage
	\setcaptionmargincm{\captionlrmarginmc}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.0.0-beta-6-CTR/EXM},
		Template.Version.Hash={058292FF42F1979FAF42DC5507E1F0DA},
		Template.Version.Release={4.0.0},
	...
	pdfproducer={Template-Controles v4.0.0 | (Pablo Pizarro R.) ppizarror.com},
