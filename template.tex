...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.0.0-alpha-4-CTR/EXM},
		Template.Version.Hash={2A6205F3EB12141D49922D08D63A984A},
...
\ifthenelse{\equal{\stylecitereferences}{natbib}}{
	\bibliographystyle{\natbibrefstyle}
	\setlength{\bibsep}{\natbibrefsep pt}
	%\newcommand{\shortcite}[1]{\texttt{\textbackslash shortcite\{#1\}}\throwwarning{Esta funcion no es soportada con el uso de las referencias natbib}}
	%\newcommand{\fullcite}[1]{\texttt{\textbackslash fullcite\{#1\}}\throwwarning{Esta funcion no es soportada con el uso de las referencias natbib}}
...
\ifthenelse{\equal{\stylecitereferences}{apacite}}{
	...
	%\newcommand{\citet}[1]{\texttt{\textbackslash citet\{#1\}}\throwwarning{Esta funcion no es soportada con el uso de las referencias apacite}}
	%\newcommand{\citep}[1]{\texttt{\textbackslash citep\{#1\}}\throwwarning{Esta funcion no es soportada con el uso de las referencias apacite}}
