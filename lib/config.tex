...
\def\marginalignbottom {-0.30}     % Margen inferior ecuaciones [cm]
\def\marginaligncaptbottom {0.05}  % Margen inferior caption ecuación [cm]
\def\marginaligncapttop {-0.60}    % Margen superior caption ecuación [cm]
\def\marginaligntop {-0.40}        % Margen superior ecuaciones [cm]
...
\def\marginequationbottom {-0.05}  % Margen inferior ecuaciones [cm]
...
\def\margingatherbottom {0.0}      % Margen inferior ecuaciones [cm]
...
\def\margingathertop {-0.40}       % Margen superior ecuaciones [cm]
\def\marginimagebottom {-0.10}     % Margen inferior figura [cm]
...
\def\showdotontitles {false}       % Punto al final de n° (s/ss/sss/ssss)ection
