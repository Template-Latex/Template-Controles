...
\def\captionalignment {justified} % Alineaado leyenda (justified,centered,left,right)
...
\def\anumsecaddtocounter {false}  % Fn. para insertar títulos anum. aumenta contador
...
\def\showdotontitles {false}      % Punto al final de N° de título/sub(sub)título
...
\def\cfgbookmarksopenlevel {1}    % Nivel de los marcadores (2: subsecciones)
