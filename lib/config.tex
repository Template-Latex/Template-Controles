...
\def\ssstitlecolor {black}         % Color de los sub-sub-subtitulos
...
\def\showdotontitles {false}       % Punto al final de n° (ti/sub/subsub)título
\def\stylessstitle {\bfseries}     % Estilo sub-sub-subtitulos
