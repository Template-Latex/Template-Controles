...
\ifthenelse{\equal{\natbibtextalign}{justify}}{
		}{
		\ifthenelse{\equal{\natbibtextalign}{left}}{
			\raggedright
		}{
		\ifthenelse{\equal{\natbibtextalign}{right}}{
			\raggedleft
		}{
		\ifthenelse{\equal{\natbibtextalign}{center}}{
			\centering
		}{
			\throwbadconfig{Ajuste de linea referencias desconocido}{\natbibtextalign}{justified,left,right,center}}}}
		}
	}
	{
	\end{thebibliography}
