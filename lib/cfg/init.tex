...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={3.2.6-1-CTR/EXM-N},
		Template.Version.Hash={CAF3039A8F9DEE3C55D967D42B67A523},
		Template.Version.Release={3.2.6},
		Template.Web.Dev={https://github.com/Template-Latex/Template-Controles/},
		Template.Web.Manual={https://latex.ppizarror.com/Template-Controles/},
	...
	pdfproducer={Template-Controles v3.2.6 | (Pablo Pizarro R.) ppizarror.com},
...
\unaccentedoperators
\AtEndDocument{
	\setcounter{equation}{\value{templateEquations}}
	\setcounter{figure}{\value{templateFigures}}
	\setcounter{lstlisting}{\value{templateListings}}
	\setcounter{table}{\value{templateTables}}
}
