...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={1.2.5-CTR/EXM-N},
		Template.Version.Hash={6924F50002CC47752C54EF26BABF77CF},
		Template.Version.Release={1.2.5},
	...
	pdfproducer={Template-Controles v1.2.5 | (Pablo Pizarro R.) ppizarror.com},
...
\ifthenelse{\equal{\showlinenumbers}{true}}{
	\setlength{\linenumbersep}{0.2cm} % Espaciado entre número de línea y texto
	\renewcommand\linenumberfont{\normalfont\tiny\color{gray}} % Estilo número
	}{
}
