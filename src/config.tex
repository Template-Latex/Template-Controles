...
\def\marginaligncaptbottom {0.05}  % Margen inferior caption en align [cm]
\def\marginaligncapttop {-0.60}    % Margen superior caption en align [cm]
\def\marginalignedcaptbottom {0.0} % Margen inferior caption en aligned [cm]
\def\marginalignedcapttop {-0.60}  % Margen superior caption en aligned [cm]
\def\margineqncaptionbottom {0.0}  % Margen inferior caption ecuación [cm]
\def\margineqncaptiontop {-0.70}   % Margen superior caption ecuación [cm]
\def\margingathercaptbottom {0.05} % Margen inferior caption en gather [cm]
\def\margingathercapttop {-0.90}   % Margen superior caption en gather [cm]
\def\margingatheredcaptbottom {0}  % Margen inf. caption en gathered [cm]
\def\margingatheredcapttop {-0.90} % Margen superior caption en gathered [cm]
...
\def\apaciterefciteclose {]}       % Caracter final cita apacite
\def\apaciterefciteopen {[}        % Caracter inicial cita apacite
...
\def\natbibrefcharclose {]}        % Caracter final cita natbib
\def\natbibrefcharopen {[}         % Caracter inicial cita natbib
