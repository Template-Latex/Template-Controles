...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={4.3.0-1-CTR/EXM},
		Template.Version.Hash={FA3DA7BC2DE08829562A97FF0A0F3E05},
		Template.Version.Release={4.3.0},
	...
	pdfproducer={Template-Controles v4.3.0 | (Pablo Pizarro R.) ppizarror.com},
...
\ifthenelse{\equal{\stylecitereferences}{apacite}}{
	\ifthenelse{\equal{\apaciterefnumber}{true}}{
		...
		\renewcommand{\theapaciteNumberCounter}{% Formato de número
			\apaciterefciteopen\arabic{apaciteNumberCounter}\apaciterefciteclose
		}
