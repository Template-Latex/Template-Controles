...
var image_url = 'http://ppizarror.com/Template-Informe/images/' + images_background[images_indx_random][0];
...
$.getJSON("https://api.github.com/repos/ppizarror/Template-Controles/releases", function(json) {
    ...
    try {
        ...
        new_version_entry += "Puedes ver la lista de cambios completa <a href='https://github.com/ppizarror/Template-Controles/releases'>en Github<img src='resources/github.png' width='16px' height='16px' class='iconbutton' /></a>";
